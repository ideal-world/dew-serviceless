...
public class CacheApplicationTest extends DewAuthApplication<CacheApplicationTest.TestDewCacheConfig> {
    ...
    @Override
    protected Future<?> start(TestDewCacheConfig config) {
        return super.start(config);
    }

    @Override
    protected Future<?> stop(TestDewCacheConfig config) {
        return Future.succeededFuture();
    }

    public static class TestDewCacheConfig extends DewAuthConfig {
