...
package idealworld.dew.serviceless.common.resp;
...
public class StandardResp {
     ...
     * Sets service flag.
     *
     * @param inputServiceFlag the service flag
     */
    public static void setServiceFlag(String inputServiceFlag) {
